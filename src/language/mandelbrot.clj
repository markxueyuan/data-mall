...
(defn mandelbrot
  ...
  (doall (mapper (mandelbrot-pixel max-x max-y max-iterations set-range)
                 (output-points max-x max-y))))

;(def mandelbrot-range {:x [-2.5 1.0] :y [-1.0 1.0]})

;(def m (time (mandelbrot map 500 1000 1000 mandelbrot-range)))

;(def m (time (mandelbrot pmap 500 1000 1000 mandelbrot-range)))

;(def m (time (mandelbrot map 1000 1000 1000 mandelbrot-range)))

;(def m (time (mandelbrot pmap 1000 1000 1000 mandelbrot-range)))
